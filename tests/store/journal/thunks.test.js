...
import { startCreatingNote, startDeletingNote, startLoadingNotes, startSavingNote } from '../../../src/store/journal/thunks';
...
describe('Tests on Journal thunks', () => {
  ...
  test('Should start deleting note', async () => {
    ...
    const newNoteReferenceID = await setNewNote(newNote, `${testUID}/journal/notes`);
    newNote.id = newNoteReferenceID;
