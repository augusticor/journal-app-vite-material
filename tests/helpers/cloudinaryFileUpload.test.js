...
const { VITE_CLOUDNAME, VITE_APIKEY, VITE_APISECRET } = getEnvironments();
...
describe('Tests on cloudinary image upload', () => {
  test('Test image upload to cloudinary', async () => {
    const imageUrl = 'https://res.cloudinary.com/dg2nreez0/image/upload/v1644623071/samples/ecommerce/shoes.png';
